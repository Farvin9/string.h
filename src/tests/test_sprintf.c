...
START_TEST(n_specifier) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format, &ret),
...
START_TEST(test_one_float) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%f", 0.0001),
...
START_TEST(test_one_char_with_alignment_right) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%-8c", '\t'),
                   sprintf(str2, "%-8c", '\t'));
...
START_TEST(test_one_hex_lower_with_width_star) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, "%*x", 11, 0),
                   sprintf(str2, "%*x", 11, 0));
  ck_assert_str_eq(str1, str2);
...
START_TEST(test_sprintf26) {
  ...
  ck_assert_int_eq(d3_sprintf(str1, format), sprintf(str2, format));

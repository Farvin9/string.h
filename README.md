...
- Оформить решение как статическую библиотеку (с заголовочным файлом d3_string.h)
...
- Предусмотреть Makefile для сборки библиотеки и тестов (с целями all, clean, test, d3_string.a, gcov_report)
...
- Функция должна быть размещена в библиотеке d3_string.h.
